...
public class StringUtil {
	...
	//暂只过滤这2种字符   https://www.utf8-chartable.de/unicode-utf8-table.pl?utf8=dec
	private final static char[] special = new char[]{0xc2, 0xa0};
...
//		buf.append(CmsConstants.SYSTEMCONFIG.get("PORTAL_MDN"));//"MDN2000"
	 ...
	 * @return
	 */
    public static String cleanSpecialChar(String value) {
    	if(isNull(value)) {
    		return value;
    	}
    	...
    	try {
    		String rst = value;
			for(char c : special) {
				String sp = String.valueOf(new char[]{ c });
				rst = rst.replace(sp, " ");
			}
			return rst;
		} catch (Exception e) {
